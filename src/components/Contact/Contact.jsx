  ...
  const [modal, showModal] = useState(false);
    return (
        <div className='contact' id='contact'>
            <h1 style={{ fontSize: ' 8vw', textAlign: "center", textTransform: 'uppercase', opacity: '0.3' }}>
                Contact
            </h1>
            <div className='contactme'>
                <form className='form' action="https://formsubmit.co/blogeesnow@gmail.com" method="POST" autoComplete="off" >
